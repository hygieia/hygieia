...
public interface DashboardRepository extends PagingAndSortingRepository<Dashboard, ObjectId> {
	...
	List<Dashboard> findAllByTypeContainingIgnoreCaseAndConfigurationItemBusServNameContainingIgnoreCase(DashboardType type, String appName);
	List<Dashboard> findAllByTypeContainingIgnoreCaseAndConfigurationItemBusServNameContainingIgnoreCaseAndConfigurationItemBusAppNameContainingIgnoreCase(DashboardType type, String appName, String compName);
