...
public class StoryDataClientImpl implements StoryDataClient {
     ...
     *
     * @param currentPagedJiraRs A list response of Jira issues from the source system
     */
     ...
     *
     * @param nativeStatus The status label as native to Jira
     ...
     *
     * @param epicKey A given Epic Key
