...
public class DefaultBitbucketServerClientTest {
    ...
    public void testBuildUri() throws URISyntaxException {
        ...
        res = client.buildUri(url1, null, null, "commit");
        ...
        res = client.buildUri(url2, null, null, "commit");
        ...
        res = client.buildUri(url3, null, null, "commit");
        ...
        // try branch
        res = client.buildUri(url2, branch1, null, "commit");
        ...
        // try since
        res = client.buildUri(url2, null, lastKnownCommit1, "commit");
        ...
        // try no page limit
        settings.setPageSize(-1);
        res = client.buildUri(url2, "master", null, "commit");
