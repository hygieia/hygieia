...
public class GitRepo extends CollectorItem {
    ...
    public static final String LAST_UPDATE_PULL_REQUEST = "updatedDate";
    ...
    public static String getLastUpdatePullRequest() {
        return LAST_UPDATE_PULL_REQUEST;
    }

    public void setLastUpdatePullRequest(String sha) {
        getOptions().put(LAST_UPDATE_PULL_REQUEST, sha);
    }
