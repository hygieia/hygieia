...
public class HpsmCollectorTests {

	
	private HpsmCollector githubRepo1;
	private HpsmCollector githubRepo2;
	private HpsmCollector githubRepo3;
	
	
	
	@Before
    public void init() {
//		githubRepo1 = new HpsmCollector();
//		githubRepo1.setRepoUrl("https://github.com/capitalone/Hygiea.git");
//		githubRepo1.setBranch("master");
//		githubRepo2 = new HpsmCollector();
//		githubRepo2.setRepoUrl("https://github.com/capitalone/Hygiea.git");
//        githubRepo2.setBranch("master");
//        githubRepo3=new HpsmCollector();
