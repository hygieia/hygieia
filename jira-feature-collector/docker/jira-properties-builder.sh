...
then
	...
	DEFAULT_PROP_FILE=hygieia-jira-feature-collector.properties
fi
...
feature.jiraIssueTypeId=${JIRA_ISSUE_TYPE_ID:-7}
...
echo "
===========================================
Properties file created:  $SPRING_CONFIG_LOCATION
Note: passwords hidden
===========================================
$(egrep -vi 'password|Credentials|Authtoken' "$SPRING_CONFIG_LOCATION")
" 
