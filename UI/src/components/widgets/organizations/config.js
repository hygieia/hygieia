...
(function() {
	...
	angular.module(HygieiaConfig.module).controller('OrganizationConfigController',
			OrganizationConfigController);

	OrganizationConfigController.$inject = [ 'modalData', '$modalInstance',
			'collectorData' ];
	function OrganizationConfigController(modalData, $modalInstance, collectorData) {
		var ctrl = this;
