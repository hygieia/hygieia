...
(function() {
	...
	angular.module(HygieiaConfig.module).controller('IssueClosedConfigController',
		IssueClosedConfigController);

	IssueClosedConfigController.$inject = [ 'modalData', '$modalInstance',
		'collectorData' ];
	function IssueClosedConfigController(modalData, $modalInstance, collectorData) {
		var ctrl = this;
