...
(function() {
	...
	angular.module(HygieiaConfig.module).controller('LeveltwomanagerConfigController',
			LeveltwomanagerConfigController);

	LeveltwomanagerConfigController.$inject = [ 'modalData', '$modalInstance',
			'collectorData' ];
	function LeveltwomanagerConfigController(modalData, $modalInstance, collectorData) {
		var ctrl = this;
