(function () {
    ...
    featureViewController.$inject = ['$scope', '$q', '$interval', 'collectorData', 'featureData'];

    function featureViewController($scope, $q, $interval, collectorData, featureData) {
        ...
        ctrl.load = function () {
            ...
            console.log("barOPtions = ", ctrl.barOptions);
            console.log("barData = ", ctrl.barData);
            return deferred;
        };
        ...
        function processSprintResponse(data, isKanban) {
            ...
            ctrl.sprintId = ctrl.iterations[0].id;
