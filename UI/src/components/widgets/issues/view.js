(function () {
    ...
    angular
        ...
        .controller('IssueViewController', IssueViewController);

    IssueViewController.$inject = ['$q', '$scope','issueRepoData', '$modal'];
    function IssueViewController($q, $scope, issueRepoData, $modal) {
        var ctrl = this;
        ...
        function showDetail(evt) {
            ...
            $modal.open({
                ...
                controllerAs: 'detail',
                templateUrl: 'components/widgets/issues/detail.html',
                size: 'lg',
                resolve: {
                    issues: function() {
