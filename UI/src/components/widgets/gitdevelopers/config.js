...
(function() {
	...
	angular.module(HygieiaConfig.module).controller('GitdeveloperConfigController',
			GitdeveloperConfigController);

	GitdeveloperConfigController.$inject = [ 'modalData', '$modalInstance',
			'collectorData' ];
	function GitdeveloperConfigController(modalData, $modalInstance, collectorData) {
		var ctrl = this;
