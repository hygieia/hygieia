...
(function() {
	...
	angular.module(HygieiaConfig.module).controller('PullMergedConfigController',
		PullMergedConfigController);

	PullMergedConfigController.$inject = [ 'modalData', '$modalInstance',
			'collectorData' ];
	function PullMergedConfigController(modalData, $modalInstance, collectorData) {
		var ctrl = this;
