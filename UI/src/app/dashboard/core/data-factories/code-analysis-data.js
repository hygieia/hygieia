...
(function () {
    ...
    function codeAnalysisData($http) {
        ...
        function staticDetails(params) {
            return $http.get(HygieiaConfig.localTesting ? testStaticDetailRoute : caStaticDetailsRoute, { params: params })
                .then(function (response) { return response.data; });
        }

        function securityDetails(params) {
            return $http.get(HygieiaConfig.localTesting ? testSecDetailRoute : caSecDetailsRoute, { params: params })
                .then(function (response) { return response.data; });
        }
    }
