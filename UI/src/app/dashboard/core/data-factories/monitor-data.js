...
(function () {
    ...
    function monitorData($http) {
        ...
        function search() {
            return $http.get(HygieiaConfig.localTesting ? testingSearchRoute : serviceRoute)
        ...
        function details(dashboardId) {
            return $http.get(HygieiaConfig.localTesting ? testingDetailRoute : getServiceRoute(dashboardId))
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function createService(dashboardId, name) {
            return $http.post(HygieiaConfig.localTesting ? testingDetailRoute : getServiceRoute(dashboardId), JSON.stringify(name))
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function updateService(dashboardId, service) {
            ...
            return $http.put(HygieiaConfig.localTesting ? testingDetailRoute : getServiceRoute(dashboardId) + serviceId, service)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function deleteService(dashboardId, serviceId) {
            return $http.delete(HygieiaConfig.localTesting ? testingDetailRoute : getServiceRoute(dashboardId) + serviceId)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function createDependentService(dashboardId, serviceId) {
            return $http.post(HygieiaConfig.localTesting ? testingDetailRoute : getDependentServiceRoute(dashboardId) + serviceId, {})
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function deleteDependentService(dashboardId, serviceId) {
            return $http.delete(HygieiaConfig.localTesting ? testingDetailRoute : getDependentServiceRoute(dashboardId) + serviceId)
                .then(function (response) {
                    return response.data;
                });
        }
