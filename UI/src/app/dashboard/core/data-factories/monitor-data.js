...
(function () {
    ...
    function monitorData($http) {
        ...
        function search() {
            return $http.get(localTesting ? testingSearchRoute : serviceRoute)
        ...
        function details(dashboardId) {
            return $http.get(localTesting ? testingDetailRoute : getServiceRoute(dashboardId))
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function createService(dashboardId, name) {
            return $http.post(localTesting ? testingDetailRoute : getServiceRoute(dashboardId), JSON.stringify(name))
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function updateService(dashboardId, service) {
            ...
            return $http.put(localTesting ? testingDetailRoute : getServiceRoute(dashboardId) + serviceId, service)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function deleteService(dashboardId, serviceId) {
            return $http.delete(localTesting ? testingDetailRoute : getServiceRoute(dashboardId) + serviceId)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function createDependentService(dashboardId, serviceId) {
            return $http.post(localTesting ? testingDetailRoute : getDependentServiceRoute(dashboardId) + serviceId, {})
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function deleteDependentService(dashboardId, serviceId) {
            return $http.delete(localTesting ? testingDetailRoute : getDependentServiceRoute(dashboardId) + serviceId)
                .then(function (response) {
                    return response.data;
                });
        }
