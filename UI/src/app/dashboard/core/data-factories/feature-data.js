...
(function () {
    ...
    function featureData($http) {
        ...
        // sprint health gadget data
        var testSprintHealthRoute = 'test-data/sprinthealth.json';
        var buildSprintHealthRoute = '/api/sprinthealthgadget/';
        ...
        /**
         * Retrieve the sprint health regarding the displayed sprint
         *
         * @param collectorId
         */
        function sprintHealth(collectorId, sprintId) {
            console.log("sprint ID = ", sprintId)
            return $http.get(HygieiaConfig.local ? testSprintHealthRoute : buildSprintHealthRoute + collectorId + "/" + sprintId)
                .then(function (response) {
                    return response.data;
                });
        }
