...
(function() {
	...
	function featureData($http) {
		...
		function total(componentId,filterTeamId) {
			return $http.get(HygieiaConfig.localTesting ? testTotal : buildTotal + filterTeamId + param + componentId)
		...
		function wip(componentId,filterTeamId) {
			return $http.get(HygieiaConfig.localTesting ? testWip : buildWip + filterTeamId + param + componentId)
					.then(function(response) {
						return response.data;
					});
		}
		...
		function done(componentId,filterTeamId) {
			return $http.get(HygieiaConfig.localTesting ? testDone : buildDone + filterTeamId + param + componentId)
					.then(function(response) {
						return response.data;
					});
		}
		...
		function featureWip(componentId,filterTeamId) {
			return $http.get(HygieiaConfig.localTesting ? testFeatureWip : buildFeatureWip + filterTeamId + param + componentId)
					.then(function(response) {
						return response.data;
					});
		}
		...
		function sprint(componentId,filterTeamId) {
			return $http.get(HygieiaConfig.localTesting ? testSprint : buildSprint + filterTeamId + param + componentId)
					.then(function(response) {
						return response.data;
					});
		}
		 ...
		 */
		function teams() {
			return $http.get(HygieiaConfig.localTesting ? testTeams : buildTeams)
					.then(function(response) {
						return response.data;
					});
		}
		...
		function teamByCollectorItemId(collectorItemId) {
			return $http.get(HygieiaConfig.localTesting ? testTeamByCollectorItemId : buildTeamByCollectorItemId + collectorItemId)
					.then(function(response) {
						return response.data;
					});
		}
