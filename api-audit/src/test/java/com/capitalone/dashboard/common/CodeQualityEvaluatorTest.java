...
public class CodeQualityEvaluatorTest {
    ...
    public void testEvaluate_CodeQualityNotConfigured(){
        ...
        System.out.println(response.getAuditStatuses().toString());
    ...
    public void testEvalatefor_COLLECTOR_ITEM_ERROR(){
        List<CodeQuality> codeQualities = makeCodeQuality("cloud-service-parent");
    ...
    private List<CodeQuality> makeCodeQuality(String name) {
        ...
        codeQualityMetric4.setStatus(CodeQualityMetricStatus.Ok);
