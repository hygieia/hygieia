...
public interface IssueService {
     ...
     * @return Issues matching criteria
     */
    DataResponse<Iterable<Issue>> searchOpen(IssueRequest request);
    ...
    DataResponse<Iterable<Issue>> searchByOrgs(IssueRequest request);
    ...
    DataResponse<Iterable<Issue>> searchClosedByOrgs(IssueRequest request);
    ...
    DataResponse<Iterable<Issue>> searchOpenByOrgs(IssueRequest request);
    */
