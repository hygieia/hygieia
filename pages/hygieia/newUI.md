...
For instructions on how to setup the new UI, please navigate to the [**README**](https://github.com/hygieia/hygieia/blob/master/README.md) of our Hygieia UI [**Github repo**](https://github.com/hygieia/hygieia). 
...
Please visit the bottom of the new Hygieia UI [**README**](https://github.com/hygieia/hygieia/blob/master/README.md) for information about debugging.

## UI Progress (up to date)

For information about the latest changes regarding the new UI, please visit our [**UI Progress wiki page**](https://github.com/hygieia/hygieia/wiki/UI-Progress).
