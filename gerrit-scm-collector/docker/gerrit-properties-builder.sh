...
then
	...
	PROP_FILE=hygieia-gerrit-scm-collector.properties
fi
...
gerrit.cron=${gerrit_CRON:-0 0/5 * * * *}

gerrit.host=${gerrit_HOST:-gerrit.com}

#Maximum number of days to go back in time when fetching commits
gerrit.commitThresholdDays=${gerrit_COMMIT_THRESHOLD_DAYS:-15}
