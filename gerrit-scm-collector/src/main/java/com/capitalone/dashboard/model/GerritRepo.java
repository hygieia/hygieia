 ...
 */
public class GerritRepo extends CollectorItem {
    private static final String PROJECT = "url"; // http://github.company.com/jack/somejavacode
    ...
    public void setProject(String instanceUrl) {
        getOptions().put(PROJECT, instanceUrl);
    }
    ...
    public boolean equals(Object o) {
        ...
        GerritRepo gitHubRepo = (GerritRepo) o;

        return getProject().equals(gitHubRepo.getProject()) & getBranch().equals(gitHubRepo.getBranch());
    }
