...
import { SCMEvidenceComponent } from './scm-evidence.component';
...
describe('SCMEvidenceComponent', () => {
  let component: SCMEvidenceComponent;
  let fixture: ComponentFixture<SCMEvidenceComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SCMEvidenceComponent);
