...
import { DeploymentEvidenceComponent } from './deployment-evidence.component';
...
describe('DeploymentEvidenceComponent', () => {
  let component: DeploymentEvidenceComponent;
  let fixture: ComponentFixture<DeploymentEvidenceComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DeploymentEvidenceComponent);
