...
export class StaticSecurityScanEvidenceComponent
  extends BaseEvidenceComponent
  implements OnInit {
  ...
  ngOnInit() {
    super.ngOnInit();
    this.intervalRefreshSubscription = this.ciViewerService
      .getCollectorItemDetails(
        this.dashboardTitle,
        this.componentId,
        this.collector
      )
