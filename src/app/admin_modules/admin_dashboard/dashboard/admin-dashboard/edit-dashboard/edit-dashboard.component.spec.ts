...
describe('EditDashboardComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [EditDashboardComponent, EditDashboardModalComponent, GeneralDeleteComponent ],
      providers: [{ provide: DashboardDataService, useClass: MockDashboardDataService },
        CmdbDataService, UserDataService, AdminDashboardService,
        { provide: PaginationWrapperService, useClass: MockPaginationWrapperService }],
  ...
  beforeEach(() => {
    ...
    page = TestBed.inject(PaginationWrapperService);
