...
public class StoryDataClientImpl {
    ...
    protected void updateMongoInfo(JSONArray tmpMongoDetailArray) {
        for (Object obj : tmpMongoDetailArray) {
            ...
            // sOwnersShortName
            feature.setsOwnersShortName(ClientUtil.toCanonicalList((List<String>) dataMainObj
                    .get("Owners.Nickname")));

            // sOwnersFullName
            feature.setsOwnersFullName(ClientUtil
                    .toCanonicalList((List<String>) dataMainObj
                            .get("Owners.Name")));

            // sOwnersUsername
            feature.setsOwnersUsername(ClientUtil
                    .toCanonicalList((List<String>) dataMainObj
                            .get("Owners.Username")));
            ...
            // sOwnersIsDeleted
            feature.setsOwnersIsDeleted(ClientUtil
                    .toCanonicalList((List<String>) dataMainObj
    ...
    protected void removeExistingEntity(String localId) {
        ...
        if (CollectionUtils.isEmpty(listOfFeature)) return;
    ...
    public String getMaxChangeDate() {
        ...
        List<Feature> response = featureRepo
                .findTopByCollectorIdAndChangeDateGreaterThanOrderByChangeDateDesc(col.getId(), featureSettings
                        .getDeltaStartDate());
